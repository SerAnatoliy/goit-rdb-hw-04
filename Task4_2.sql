...
/* Кількість рядків в резлультаті запиту: зібльшилась внаслідок того що деякі звязки були змінені на праві або ліві, тому при відсутності відповідності деякі поля були заповнені Null */